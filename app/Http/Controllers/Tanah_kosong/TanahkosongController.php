...
class TanahkosongController extends Controller
{
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'bentuk_tanah_lainnya' => 'nullable|required_if:bentuk_tanah,Lainnya|string|max:255',
        ...
        TanahKosong::create([
            ...
            'bentuk_tanah_lainnya' => $request->bentuk_tanah === 'Lainnya' ? $request->bentuk_tanah_lainnya : null,
