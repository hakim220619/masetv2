        ...
        <div class="col-md-4">
            <div class="card text-center shadow">
                <div class="card-body">
                    ...
                    <h2 style="color: red;">{{ $total_objek_penilaian->total_objek }}</h2>
        ...
        <div class="col-md-4">
            <div class="card text-center shadow">
                <div class="card-body">
                    ...
                    <h2 style="color: red;">{{ $total_users->tot_users }}</h2>
                    <p>TOTAL CLIENT</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-center shadow">
                <div class="card-body">
                    ...
                    <h2 style="color: red;">{{ $total_pembanding }}</h2>
                    <p>DATA PEMBANDING</p>
                </div>
            </div>
        </div>
                    ...
                    <form action="" method="GET">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="cariLaporan" name="cari_laporan"
                                    placeholder="Cari...">
                            </div>
                            <!-- Cari Pemberi Tugas -->
                            <div class="col-md-6 mb-3">
                                <label for="cariPemberiTugas" class="form-label"><strong>Cari Pemberi Tugas</strong></label>
                                <input type="text" class="form-control" id="cariPemberiTugas" name="cari_pemberi_tugas"
                                    placeholder="Cari...">
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="vertical-align: middle;">
                                PT Bank Central Asia Tbk KCU Rungkut - CV Wujud Unggul - Pergudangan Grand Tambak Sawah
                                B-05, Kelurahan Tambaksawah, Kecamatan Waru, Kabupaten Sidoarjo, Provinsi Jawa Timur,
                                Indonesia
                            </td>
                        ...
                        <tr>
                            <td style="vertical-align: middle;">
                                PT Bank Central Asia Tbk KCU Magelang - Setyo Hermawan - Jl. Daendels, Desa Lembupurwo,
                                Kecamatan Mirit, Kabupaten Kebumen, Provinsi Jawa Tengah, Indonesia
                            </td>
