                    ...
                    <form method="POST" action="{{ route('add_pembanding_tanah_kosong') }}" enctype="multipart/form-data">
                        ...
                        <div id="account-details" class="content">
                            <div class="row g-3">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div id="kabupaten-container">
                                                        ...
                                                        <select id="kabupaten_default" name="kabupaten" class="form-select">
                                                            <option value="" selected>- Pilih Kabupaten/Kota -
                                                            </option>
                                                        </select>

                                                        <!-- Kabupaten Aceh -->
                                                        <select id="kabupaten_1100" name="kabupaten"
                                                        ...
                                                        <select id="kabupaten_1600" name="kabupaten"
                                                            ...
                                                            <option value="1612_0.815">Kab. Penukal Abab Lematang Ilir
                                                            </option>
                                                        ...
                                                        <select id="kabupaten_7100" name="kabupaten"
                                                            ...
                                                            <option value="7107_0.929">Kab. Bolaang Mongondow Utara
                                                            </option>
                                                            <option value="7108_1.037">Kab. Kep. Siau Tagulandang Biaro
                                                                (sitaro)</option>
                                                            <option value="7109_0.946">Kab. Minahasa Tenggara</option>
                                                            <option value="7110_0.829">Kab. Bolaang Mongondow Selatan
                                                            </option>
                                                            <option value="7111_0.976">Kab. Bolaang Mongondow Timur
                                                            </option>
                                                        ...
                                                        <select id="kabupaten_7300" name="kabupaten"
                                                            ...
                                                            <option value="7309_0.820">Kab. Pangkajene &amp; Kepulauan
                                                            </option>
                                                        ...
                                                        <select id="kabupaten_9400" name="kabupaten"
                                                            ...
                                                            <option value="9408_1.251">Kab. Kep. Yapen (yapen Waropen)
                                                            </option>
                                ...
                                <div>
                                    <label class="form-label" for="keterangan_dasar_nilai">Keterangan Dasar Nilai pada
                                        Tabel Analisis</label>
                                    <input type="text" id="keterangan_dasar_nilai" name="keterangan_dasar_nilai"
                                        class="form-control"
                                        placeholder="indikasi niali liquiditas/nilai investasi/nilai sewa pasar" />
                                </div>
                                <div>
                                    ...
                                    <table class="table table-bordered" id="fotoLainnyaTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" name="judul_foto[0]" class="form-control" />
                                                </td>
                                                <td><input type="file" id="foto_lainnya" name="foto[0]"
                                    ...
                                    <table class="table table-bordered" id="njopTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number" name="njop[0][tahun]" class="form-control" />
                                                </td>
                        ...
                        <div id="personal-info" class="content">
                            <div class="row g-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="harga_penawaran" name="harga_penawaran"
                                ...
                                <div>
                                    <label class="form-label" for="harga_sewa_per_tahun">Harga Sewa per Tahun
                                        (Rp/tahun)</label>
                        ...
                        <div id="address" class="content">
                            <div class="row g-3">
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="ketinggian_tanah_dr_muka_jln">Ketinggian Tanah
                                            dari Muka Jalan (m)</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="kondisi_lingkungan_khusus"
                                            id="kondisi_lingkungan_khusus" aria-label="Default select example">
                                            <option value="" selected disabled>Pilih...</option>
                                            ...
                                            <option value="Dekat Kumpulan Bangunan Liar">Dekat Kumpulan Bangunan Liar
                                            </option>
                                            <option value="Dekat Jurang/ Rawan Longsor">Dekat Jurang/ Rawan Longsor
                                            </option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div style="background-color: rgb(244, 241, 241);" class="p-3 rounded mb-3">
                                            <label class="form-label" for="karakteristik_ekonomi">Karakteristik Ekonomi
                                                (Jika objek yang dinilai adalah Properti Komersial)</label>
                                            <table class="table table-borderless">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <select class="form-select" name="ketentuan_sewa"
                                                            id="ketentuan_sewa" aria-label="Default select example">
                                                            <option value="" selected disabled>Pilih...</option>
                                                ...
                                                <tr>
                                                    <td>
                                                        <select class="form-select" name="bauran_penyewa"
                                                            id="bauran_penyewa" aria-label="Default select example">
                                                            <option value="" selected disabled>Pilih...</option>
                                        ...
                                        <div style="background-color: rgb(244, 241, 241);" class="p-3 rounded mb-3">
                                            <label class="form-label" for="komponen_non_reality">Komponen Non-Realty
                                                dalam Penjualan</label>
                                            <table class="table table-borderless">
                                                <tr>
                                                    <th>FFE</th>
                                                    <th>Mesin</th>
                                        ...
                                        <div style="background-color: rgb(244, 241, 241);" class="p-3 rounded mb-3">
                                            <label class="form-label" for="gambaran_objek">Gambaran Objek terhadap
                                                Wilayah dan Lingkungan</label>
                                            <table class="table table-borderless">
                                                <tr>
                                                    <th>Jarak dengan CBD (Pusat Ekonomi) dari Pusat Kota. Nama Pusat Kota /
                                                        Jarak</th>
                                                    <th>Jarak dengan CBD (Pusat Ekonomi) dari Pusat Ekonomi terdekat (Pasar
                                                        Mall). Nama Pusat Ekonomi / Jarak</th>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input type="text" id="nama_pusat_kota"
                                                            name="nama_pusat_kota" class="form-control"
                                                            placeholder="Nama Pusat Kota/Jarak" />
                                                    </td>
                                                    <td>
                                                        <input type="text" id="nama_pusat_ekonomi"
                                                            name="nama_pusat_ekonomi" class="form-control"
                                                            placeholder="Nama Pusat Ekonomi/Jarak" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Jarak dengan CBD (Pusat Ekonomi) dari Jalan Utama terdekat. Nama
                                                        Jalan / Jarak</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="kondisi_lingkungan"
                                                            name="kondisi_lingkungan" class="form-control" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Faktor View (Pemandangan) untuk Properti yang faktor view
                                                        dimungkinkan sangat berpengaruh pada nilai (contoh: apartemen, vila,
                                                        dll)
                                                    </th>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="keterangan_jarak">Keterangan jarak dengan BCA
                                                terdekat (jika BCA)</label>
                                            <input type="text" id="keterangan_jarak" name="keterangan_jarak"
                                                class="form-control" placeholder="+- 1,4 KM (Bank BCA KCU Purwodadi)" />
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="pengguanan_tnh_saat_ini">Pengguanaan Tanah
                                                Saat Ini</label>
                                            <input type="text" id="pengguanan_tnh_saat_ini"
                                                name="pengguanan_tnh_saat_ini" class="form-control"
                                                placeholder="Tanah Pekarangan" />
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="pemberi_tugas">Pemberi Tugas</label>
                                            <input type="text" id="pemberi_tugas" name="pemberi_tugas"
                                                class="form-control" placeholder="Bank Mandiri" />
                                        </div>
                                        <div style="background-color: rgb(244, 241, 241);" class="p-3 rounded mb-3">
                                            <label class="form-label" for="form_isi_mandiri">Form Isian Bank
                                                Mandiri</label>
                                            <table class="table table-borderless">
                                                <tr>
                                                    <th>
                                                ...
                                                <tr>
                                                    <td>
                                                        <select name="jenis_aset" id="jenis_aset" class="form-select">
                                                            ...
                                                            <option value="Los Kerja/Bengkel/Workshop">Los
                                                                Kerja/Bengkel/Workshop</option>
                                                    ...
                                                    <td>
                                                        <select name="peruntukan" id="peruntukan" class="form-select">
                                                            ...
                                                            <option value="Industri/Pergudangan">Industri/Pergudangan
                                                            </option>
                                                            <option value="Perdagangan dan Jasa Komersial">Perdagangan dan
                                                                Jasa Komersial</option>
                                                            ...
                                                            <option value="Pemukiman Perkotaan">Pemukiman Perkotaan
                                                            </option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="jabatan_narasumber"
                                                            id="jabatan_narasumber" class="form-control">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
