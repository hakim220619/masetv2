...
@section('content')
                    ...
                    <div id="form-rumah-sederhana" style=" margin-top: 20px; display: none;">
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            ...
                            <small class="form-text text-muted">Pilih jenis bangunan yg sesuai untuk menentukan indeks
                                lantai MAPPI.</small>
                            <select class="form-control" id="jenis_bangunan_indeks_lantai"
                                name="jenis_bangunan_indeks_lantai">
                                <option value="" selected>- Select -</option>
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            ...
                            <input type="number" class="form-control" id="tahun_renovasi" name="tahun_renovasi"
                                placeholder="Enter Year" min="1900" max="2024">
                        </div>
                        <div class="form-group" style="margin-top: 20px;">
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            ...
                            <input type="number" class="form-control" id="luas_bangunan_terpotong"
                                name="luas_bangunan_terpotong" placeholder="Enter Area" min="0" step="0.01">
                        </div>
                            ...
                            <div class="area-lainnya-container-rumah-sederhana" data-type="pintu-jendela">
                                <div class="area-item d-flex align-items-center mb-2">
                                    <div style="flex: 1; margin-right: 10px;">
                                        ...
                                        <input type="text" name="nama_pintu_jendela[]" class="form-control"
                                            placeholder="Nama Area" required>
                                    </div>
                                    <div style="flex: 1; margin-right: 10px;">
                                        <label>Luas (m²)</label>
                                        <input type="number" name="luas_pintu_jendela[]" class="form-control"
                                            placeholder="Luas (m²)" min="0" step="0.01" required>
                                    </div>
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div class="area-lainnya-container-rumah-sederhana" data-type="dinding">
                                <div class="area-item d-flex align-items-center mb-2">
                                    <div style="flex: 1; margin-right: 10px;">
                                        <label>Nama Area</label>
                                        <input type="text" name="nama_dinding[]" class="form-control"
                                            placeholder="Nama Area" required>
                                    </div>
                                    <div style="flex: 1; margin-right: 10px;">
                                        <label>Luas (m²)</label>
                                        <input type="number" name="luas_dinding[]" class="form-control"
                                            placeholder="Luas (m²)" min="0" step="0.01" required>
                                    </div>
                                    <div class="area-controls">
                                        <div class="row">
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div class="area-lainnya-container-rumah-sederhana" data-type="atap-datar">
                                <div class="area-item d-flex align-items-center mb-2">
                                    <div style="flex: 1; margin-right: 10px;">
                                        <label>Nama Area</label>
                                        <input type="text" name="nama_atap_datar[]" class="form-control"
                                            placeholder="Nama Area" required>
                                    </div>
                                    <div style="flex: 1; margin-right: 10px;">
                                        <label>Luas (m²)</label>
                                        <input type="number" name="luas_atap_datar[]" class="form-control"
                                            placeholder="Luas (m²)" min="0" step="0.01" required>
                                    </div>
                                    <div class="area-controls">
                                        <div class="row">
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div class="area-lainnya-container-rumah-sederhana" data-type="atap-datar-2">
                                <div class="area-item d-flex align-items-center mb-2">
                                    <div style="flex: 1; margin-right: 10px;">
                                        <label>Nama Area</label>
                                        <input type="text" name="nama_atap_datar_2[]" class="form-control"
                                            placeholder="Nama Area" required>
                                    </div>
                                    <div style="flex: 1; margin-right: 10px;">
                                        <label>Luas (m²)</label>
                                        <input type="number" name="luas_atap_datar_2[]" class="form-control"
                                            placeholder="Luas (m²)" min="0" step="0.01" required>
                                    </div>
                                    <div class="area-controls">
                                        <div class="row">
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="Batu Kali"
                            ...
                            <div id="bobot_pondasi_batu_kali" style="display: none; margin-top: 10px;">
                                ...
                                <input type="number" class="form-control" id="bobot_batu_kali" name="bobot_batu_kali"
                                    placeholder="Masukkan bobot dalam persen" min="0" max="100"
                                    step="0.01">
                            </div>
                        </div>
                        <div class="form-group mb-3" style="margin-top: 20px;">
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        ...
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <input type="number" name="bobot_pondasi[]" class="form-control"
                                                placeholder="Masukkan bobot" min="0" max="100"
                                                step="0.01" required>
                                        </div>
                                        <div class="area-controls">
                                            <div class="row">
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2" id="show-pondasi-btn">Tambah Tipe
                                Pondasi Existing</button>
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div id="bobot_struktur_beton_bertulang" style="display: none; margin-top: 10px;">
                                ...
                                <input type="number" class="form-control" id="bobot_beton_bertulang"
                                    name="bobot_beton_bertulang" placeholder="Masukkan bobot dalam persen" min="0"
                                    max="100" step="0.01">
                            </div>
                        </div>
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_struktur[]" class="form-control" required>
                                                ...
                                                <option value="Beton Bertulang - Rumah Tinggal Mewah 2 Lantai">Beton
                                                    Bertulang - Rumah Tinggal Mewah 2 Lantai</option>
                                                <option value="Beton Bertulang - Rumah Tinggal Menengah 2 Lantai">Beton
                                                    Bertulang - Rumah Tinggal Menengah 2 Lantai</option>
                                                <option value="Beton Bertulang - Rumah Tinggal Sederhana 1 Lantai">Beton
                                                    Bertulang - Rumah Tinggal Sederhana 1 Lantai</option>
                                                <option value="Kayu - Bangunan Perkebunan (Semi Permanen) 1 Lantai">Kayu -
                                                    Bangunan Perkebunan (Semi Permanen) 1 Lantai</option>
                                                <option value="Baja Profil - Bangunan Gudang 1 Lantai">Baja Profil -
                                                    Bangunan Gudang 1 Lantai</option>
                                                <option
                                                    value="Beton Bertulang - Bangunan Gedung Bertingkat Rendah 3 Lantai (< 5 Lantai)">
                                                    Beton Bertulang - Bangunan Gedung Bertingkat Rendah 3 Lantai (< 5
                                                        Lantai)</option>
                                            </select>
                                        </div>
                                        <div style="flex: 1; margin-right: 10px;">
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                        value="Baja Ringan (Atap Asbes, Seng dll)" id="atap_baja_asbes">
                        ...
                        <div id="content-atap_dak_beton" class="content" style="display: none;">
                            ...
                            <input type="number" class="form-control" placeholder="Masukkan nilai" min="0"
                                max="100">
                        </div>
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_rangka_atap[]" class="form-control" required>
                                                <option value="">- Select -</option>
                                                <option value="118520_0.5028">Dak Beton (Jika Pakai Balok) - Rumah Tinggal
                                                    Mewah 2 Lantai</option>
                                                <option value="291406_0.5028">Kayu (Atap Genteng) - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="163018_0.5028">Kayu (Atap Asbes, Seng dll, Tanpa Reng) -
                                                    Rumah Tinggal Mewah 2 Lantai</option>
                                                <option value="207572_0.5028">Baja Ringan (Atap Genteng) - Rumah Tinggal
                                                    Mewah 2 Lantai</option>
                                                <option value="170598_0.5028">Baja Ringan (Atap Asbes, Seng dll) - Rumah
                                                    Tinggal Mewah 2 Lantai</option>
                                                <option value="101031_0.5569">Dak Beton (Jika Pakai Balok) - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="207825_0.5569">Kayu (Atap Genteng) - Rumah Tinggal Menengah
                                                    2 Lantai</option>
                                                <option value="118737_0.5569">Kayu (Atap Asbes, Seng dll, Tanpa Reng) -
                                                    Rumah Tinggal Menengah 2 Lantai</option>
                                                <option value="155172_0.5569">Baja Ringan (Atap Genteng) - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="127639_0.5569">Baja Ringan (Atap Asbes, Seng dll) - Rumah
                                                    Tinggal Menengah 2 Lantai</option>
                                                <option value="124221_1">Dak Beton (Jika Pakai Balok) - Rumah Tinggal
                                                    Sederhana 1 Lantai</option>
                                                <option value="252610_1">Kayu (Atap Genteng) - Rumah Tinggal Sederhana 1
                                                    Lantai</option>
                                                <option value="147623_1">Kayu (Atap Asbes, Seng dll, Tanpa Reng) - Rumah
                                                    Tinggal Sederhana 1 Lantai</option>
                                                <option value="214587_1">Baja Ringan (Atap Genteng) - Rumah Tinggal
                                                    Sederhana 1 Lantai</option>
                                                <option value="173204_1">Baja Ringan (Atap Asbes, Seng dll) - Rumah Tinggal
                                                    Sederhana 1 Lantai</option>
                                                <option value="78577_1">Kayu (Atap Asbes, Seng dll, Tanpa Reng) - Bangunan
                                                    Perkebunan (Semi Permanen) 1 Lantai</option>
                                                <option value="339006_1">Profil Baja - Bangunan Gudang 1 Lantai</option>
                                                <option value="112308_0.335">Dak Beton (Jika Pakai Balok) - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.3002_0.335">Kayu (Atap Genteng) - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.3003_0.335">Kayu (Atap Asbes, Seng dll, Tanpa Reng) -
                                                    Bangunan Gedung Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.3004_0.335">Baja Ringan (Atap Genteng) - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.3005_0.335">Baja Ringan (Atap Asbes, Seng dll) - Bangunan
                                                    Gedung Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                            </select>
                                        </div>
                                        <div style="flex: 1; margin-right: 10px;">
                                            <label>Bobot (%)</label>
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <input type="checkbox" id="asbes" name="tipe_atap" value="Asbes"
                                class="form-check-input">
                            <label for="asbes" class="form-check-label">Asbes</label><br>

                            <input type="checkbox" id="dak-beton" name="tipe_atap" value="Dak Beton"
                                class="form-check-input">
                            <label for="dak-beton" class="form-check-label">Dak Beton</label><br>

                            <input type="checkbox" id="fibreglass" name="tipe_atap" value="Fibreglass"
                                class="form-check-input">
                            ...
                            <input type="checkbox" id="genteng-beton" name="tipe_atap" value="Genteng Beton"
                                class="form-check-input">
                            <label for="genteng-beton" class="form-check-label">Genteng Beton</label><br>

                            <input type="checkbox" id="genteng-metal" name="tipe_atap" value="Genteng Metal"
                                class="form-check-input">
                            ...
                            <input type="checkbox" id="spandek" name="tipe_atap" value="Spandek"
                                class="form-check-input">
                            <label for="spandek" class="form-check-label">Spandek</label><br>

                            <input type="checkbox" id="pvc" name="tipe_atap" value="PVC"
                                class="form-check-input">
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_penutup-atap-existing[]" class="form-control" required>
                                                ...
                                                <option value="307588_0.5028">Dak Beton - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="235683_0.5028">Fibreglass - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="239427_0.5028">Genteng Keramik Glazur - Rumah Tinggal Mewah
                                                    2 Lantai</option>
                                                <option value="165717_0.5028">Genteng Tanah Liat - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="216861_0.5028">Genteng Beton - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="219751_0.5028">Genteng Metal - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="207566_0.5028">Bitumen (Ondulin/ Onduvilla) - Rumah Tinggal
                                                    Mewah 2 Lantai</option>
                                                <option value="403405_0.5028">Tegola - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="276586_0.5028">Sirap - Rumah Tinggal Mewah 2 Lantai</option>
                                                <option value="148318_0.5028">Spandek - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="262711_0.5028">PVC - Rumah Tinggal Mewah 2 Lantai</option>
                                                <option value="72551_0.5569">Asbes - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="235656_0.5569">Dak Beton - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="142642_0.5569">Fibreglass - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="160060_0.5569">Genteng Keramik Glazur - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="106213_0.5569">Genteng Tanah Liat - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="151664_0.5569">Genteng Beton - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="146988_0.5569">Genteng Metal - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="129846_0.5569">Bitumen (Ondulin/ Onduvilla) - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="332904_0.5569">Tegola - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="78978_0.5569">Seng Gelombang - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="243334_0.5569">Sirap - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="75361_0.5569">Spandek - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="172827_0.5569">PVC - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="117667_1">Asbes - Rumah Tinggal Sederhana 1 Lantai</option>
                                                <option value="304700_1">Dak Beton - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="234491_1">Fibreglass - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="156035_1">Genteng Tanah Liat - Rumah Tinggal Sederhana 1
                                                    Lantai</option>
                                                <option value="200470_1">Genteng Beton - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="202741_1">Genteng Metal - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="130168_1">Seng Gelombang - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="124692_1">Spandek - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="205773_1">PVC - Rumah Tinggal Sederhana 1 Lantai</option>
                                                <option value="118887_1">Asbes - Bangunan Perkebunan (Semi Permanen) 1
                                                    Lantai</option>
                                                <option value="124275_1">Seng Gelombang - Bangunan Perkebunan (Semi
                                                    Permanen) 1 Lantai</option>
                                                ...
                                                <option value="0.4001_0.335">Asbes - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="191376_0.335">Dak Beton - Bangunan Gedung Bertingkat Rendah
                                                    3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4003_0.335">Fibreglass - Bangunan Gedung Bertingkat Rendah
                                                    3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4004_0.335">Genteng Keramik Glazur - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4005_0.335">Genteng Tanah Liat - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4006_0.335">Genteng Beton - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="4007_0.335">Genteng Metal - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4008_0.335">Bitumen (Ondulin/ Onduvilla) - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.401_0.335">Tegola - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4011_0.335">Seng Gelombang - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4012_0.335">Sirap - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4013_0.335">Spandek - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4014_0.335">PVC - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                            </select>
                                        </div>
                                        <div style="flex: 1; margin-right: 10px;">
                                            <label>Bobot (%)</label>
                                            <input type="number" name="bobot_penutup-atap-existing[]"
                                                class="form-control" placeholder="Masukkan bobot" min="0"
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2"
                                id="show-penutup-atap-existing-btn">Tambah Tipe Rangka Atap Existing</button>
                        </div>
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            <label><strong>Tipe Penutup Atap Eksisting - Rumah Tinggal Sederhana 1
                                    Lantai</strong></label><br>
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_tipe-dinding-existing[]" class="form-control" required>
                                                ...
                                                <option value="273324_1.875">Bata Merah - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="274359_1.875">Bata Ringan - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="318811_1.875">Partisi Gypsumboard 2 Muka - Rumah Tinggal
                                                    Mewah 2 Lantai</option>
                                                <option value="725693_1.875">Rooster Bata - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="194325_2.143">Batako - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="244702_2.143">Bata Merah - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="252700_2.143">Bata Ringan - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="289328_2.143">Partisi Gypsumboard 2 Muka - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="703318_2.143">Rooster Bata - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="153906_2.169">Batako - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="190474_2.169">Bata Merah - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="207182_2.169">Bata Ringan - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="260248_2.169">Partisi Gypsumboard 2 Muka - Rumah Tinggal
                                                    Sederhana 1 Lantai</option>
                                                <option value="605463_2.169">Rooster Bata - Rumah Tinggal Sederhana 1
                                                    Lantai</option>
                                                <option value="336877_1.481">Papan dan Partisi Triplek Dicat - Bangunan
                                                    Perkebunan (Semi Permanen) 1 Lantai</option>
                                                ...
                                                <option value="147222_1.249">Bata Ringan - Bangunan Gudang 1 Lantai
                                                </option>
                                                <option value="226702_1.249">Dinding Spandek Rangka Baja - Bangunan Gudang
                                                    1 Lantai</option>
                                                <option value="142987_1.577">Batako - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="180055_1.577">Bata Merah - Bangunan Gedung Bertingkat Rendah
                                                    3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="185940_1.577">Bata Ringan - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="212891_1.577">Partisi Gypsumboard 2 Muka - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                            </select>
                                        </div>
                                        <div style="flex: 1; margin-right: 10px;">
                                            <label>Bobot (%)</label>
                                            <input type="number" name="bobot_tipe-dinding-existing[]"
                                                class="form-control" placeholder="Masukkan bobot" min="0"
                                                max="100" step="0.01" required>
                                        </div>
                                        <div class="area-controls">
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2"
                                id="show-tipe-dinding-existing-btn">Tambah Tipe Rangka Atap Existing</button>
                        </div>
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div id="tipe-pelapis-dinding-existing-container" style="display: none;">
                                <div class="area-lainnya-container-rumah-sederhana"
                                    data-type="tipe-pelapis-dinding-existing">
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            <label>Tipe Material</label>
                                            <select name="tipe_tipe-pelapis-dinding-existing[]" class="form-control"
                                                ...
                                                <option value="575506_1.875">Dilapis Cat (Diplester dan Diaci) - Rumah
                                                    Tinggal Mewah 2 Lantai</option>
                                                <option value="1591557_1.875">Dilapis Keramik - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="2636423_1.875">Dilapis Marmer Lokal - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="4425515_1.875">Dilapis Marmer Import - Rumah Tinggal Mewah
                                                    2 Lantai</option>
                                                <option value="2283657_1.875">Dilapis Granit/ Homogenous Tile - Rumah
                                                    Tinggal Mewah 2 Lantai</option>
                                                <option value="957120_1.875">Dilapis Wallpaper - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="2480497_1.875">Dilapis Mozaik - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="1154122_1.875">Dilapis Batu Alam - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="474683_2.143">Dilapis Cat (Diplester dan Diaci) - Rumah
                                                    Tinggal Menengah 2 Lantai</option>
                                                <option value="1235903_2.143">Dilapis Keramik - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="2300582_2.143">Dilapis Marmer Lokal - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="3777227_2.143">Dilapis Marmer Import - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="1873120_2.143">Dilapis Granit/ Homogenous Tile - Rumah
                                                    Tinggal Menengah 2 Lantai</option>
                                                <option value="881996_2.143">Dilapis Wallpaper - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="2312115_2.143">Dilapis Mozaik - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="1070661_2.143">Dilapis Batu Alam - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="332768_2.169">Dilapis Cat (Diplester dan Diaci) - Rumah
                                                    Tinggal Sederhana 1 Lantai</option>
                                                <option value="782252_2.169">Dilapis Keramik - Rumah Tinggal Sederhana 1
                                                    Lantai</option>
                                                <option value="642040_2.169">Dilapis Wallpaper - Rumah Tinggal Sederhana 1
                                                    Lantai</option>
                                                <option value="1828812_2.169">Dilapis Mozaik - Rumah Tinggal Sederhana 1
                                                    Lantai</option>
                                                <option value="856559_2.169">Dilapis Batu Alam - Rumah Tinggal Sederhana 1
                                                    Lantai</option>
                                                <option value="194807_1.249">Dilapis Cat (Diplester dan Diaci) - Bangunan
                                                    Gudang 1 Lantai</option>
                                                <option value="345190_1.577">Dilapis Cat (Diplester dan Diaci) - Bangunan
                                                    Gedung Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="909393_1.577">Dilapis Keramik - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="1378265_1.577">Dilapis Granit/ Homogenous Tile - Bangunan
                                                    Gedung Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="1701283_1.577">Dilapis Wallpaper - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="2425106_1.577">Dilapis Aluminium Composite Panel - Bangunan
                                                    Gedung Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                            </select>
                                        </div>
                                        <div style="flex: 1; margin-right: 10px;">
                                            <label>Bobot (%)</label>
                                            <input type="number" name="bobot_tipe-pelapis-dinding-existing[]"
                                                class="form-control" placeholder="Masukkan bobot" min="0"
                                                max="100" step="0.01" required>
                                        </div>
                                        <div class="area-controls">
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2"
                                id="show-tipe-pelapis-dinding-existing-btn">Tambah Tipe Rangka Atap Existing</button>
                        </div>
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div id="tipe-pintu-jendela-existing-container" style="display: none;">
                                <div class="area-lainnya-container-rumah-sederhana"
                                    data-type="tipe-pintu-jendela-existing">
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            <label>Tipe Material</label>
                                            <select name="tipe_tipe-pintu-jendela-existing[]" class="form-control"
                                                ...
                                                <option value="633004_0.145">Pintu Kayu Panil - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="430675_0.145">Pintu Kayu Dobel Triplek/ HPL - Rumah Tinggal
                                                    Mewah 2 Lantai</option>
                                                <option value="304254_0.145">Pintu Kaca Rk Aluminium - Rumah Tinggal Mewah
                                                    2 Lantai</option>
                                                <option value="503211_0.145">Jendela Kaca Rk Kayu - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="274348_0.145">Jendela Kaca Rk Aluminium - Rumah Tinggal
                                                    Mewah 2 Lantai</option>
                                                <option value="370564_0.145">Pintu Kaca Tempered Floor Hinge - Rumah
                                                    Tinggal Mewah 2 Lantai</option>
                                                <option value="141199_0.145">Pintu KM UPVC/PVC - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="507018_0.145">Pintu Garasi Kayu - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="372489_0.145">Pintu Garasi Besi - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="209200_0.145">Jendela Kaca Stopsol 8 mm Rangka Curtain Wall
                                                    - Rumah Tinggal Mewah 2 Lantai</option>
                                                <option value="174637_0.145">Jendela Kaca Tempered Frameless - Rumah
                                                    Tinggal Mewah 2 Lantai</option>
                                                <option value="319349_0.218">Pintu Kayu Panil - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="257430_0.218">Pintu Kayu Dobel Triplek/ HPL - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="308462_0.218">Pintu Kaca Rk Aluminium - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="313184_0.218">Jendela Kaca Rk Kayu - Rumah Tinggal Menengah
                                                    2 Lantai</option>
                                                <option value="312153_0.218">Jendela Kaca Rk Aluminium - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="235813_0.218">Pintu Kaca Tempered Floor Hinge - Rumah
                                                    Tinggal Menengah 2 Lantai</option>
                                                <option value="130356_0.218">Pintu KM UPVC/PVC - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="251196_0.218">Pintu Garasi Kayu - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="290195_0.218">Pintu Garasi Besi - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="152079_0.218">Jendela Kaca Stopsol 8 mm Rangka Curtain Wall
                                                    - Rumah Tinggal Menengah 2 Lantai</option>
                                                <option value="130977_0.218">Jendela Kaca Tempered Frameless - Rumah
                                                    Tinggal Menengah 2 Lantai</option>
                                                <option value="305534_0.327">Pintu Kayu Panil - Rumah Tinggal Sederhana 1
                                                    Lantai</option>
                                                <option value="236730_0.327">Pintu Kayu Dobel Triplek/ HPL - Rumah Tinggal
                                                    Sederhana 1 Lantai</option>
                                                <option value="311178_0.327">Pintu Kaca Rk Aluminium - Rumah Tinggal
                                                    Sederhana 1 Lantai</option>
                                                <option value="265053_0.327">Jendela Kaca Rk Kayu - Rumah Tinggal
                                                    Sederhana 1 Lantai</option>
                                                <option value="316582_0.327">Jendela Kaca Rk Aluminium - Rumah Tinggal
                                                    Sederhana 1 Lantai</option>
                                                <option value="65494_0.327">Pintu KM UPVC/PVC - Rumah Tinggal Sederhana 1
                                                    Lantai</option>
                                                <option value="71764_0.276">Jendela Kaca Rk Kayu - Bangunan Perkebunan
                                                    (Semi Permanen) 1 Lantai</option>
                                                <option value="74470_0.057">Pintu Besi - Bangunan Gudang 1 Lantai</option>
                                                <option value="191060_0.126">Pintu Kayu Panil - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="149554_0.126">Pintu Kayu Dobel Triplek/ HPL - Bangunan
                                                    Gedung Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="179201_0.126">Pintu Kaca Rk Aluminium - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="189366_0.126">Jendela Kaca Rk Kayu - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="191731_0.126">Jendela Kaca Rk Aluminium - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="50598_0.126">Folding Gate - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="75730_0.126">Pintu KM UPVC/PVC - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="135493_0.126">Jendela Kaca Stopsol 8 mm Rangka Curtain Wall
                                                    - Bangunan Gedung Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="42010_0.126">Rolling Door - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                            </select>
                                        ...
                                        <div style="flex: 1; margin-right: 10px;">
                                            <label>Bobot (%)</label>
                                            <input type="number" name="bobot_tipe-pintu-jendela-existing[]"
                                                class="form-control" placeholder="Masukkan bobot" min="0"
                                                max="100" step="0.01" required>
                                        </div>
                                        <div class="area-controls">
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2"
                                id="show-tipe-pintu-jendela-existing-btn">Tambah Tipe Rangka Atap Existing</button>
                        </div>
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_tipe-lantai-existing[]" class="form-control" required>
                                                ...
                                                <option value="549105_0">Granit/Homogenous Tile - Rumah Tinggal Mewah 2
                                                    Lantai</option>
                                                <option value="1380230_0">Granit Impor - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                ...
                                                <option value="700836_0">Marmer Lokal - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="1190000_0">Marmer Impor - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="657355_0">Mozaik - Rumah Tinggal Mewah 2 Lantai</option>
                                                <option value="60227_0">Rabat Beton (Semen Ekspose) - Rumah Tinggal Mewah
                                                    2 Lantai</option>
                                                <option value="536000_0">Parkit Jati - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                ...
                                                <option value="434503_0">Granit/Homogenous Tile - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="267057_0">Karpet - Rumah Tinggal Menengah 2 Lantai</option>
                                                <option value="276046_0">Keramik - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="536632_0">Marmer Lokal - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="896002_0">Marmer Impor - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="542161_0">Mozaik - Rumah Tinggal Menengah 2 Lantai</option>
                                                <option value="53245_0">Rabat Beton (Semen Ekspose) - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="423011_0">Parkit Jati - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                ...
                                                <option value="115239_0">Papan Kayu - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="260164_0">Granit/Homogenous Tile - Rumah Tinggal Sederhana
                                                    1 Lantai</option>
                                                <option value="173280_0">Karpet - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="176287_0">Keramik - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="66156_0">Rabat Beton (Semen Ekspose) - Rumah Tinggal
                                                    Sederhana 1 Lantai</option>
                                                ...
                                                <option value="102937_0">Papan Kayu - Rumah Tinggal Sederhana 1 Lantai
                                                </option>
                                                <option value="150353_0">Keramik - Bangunan Perkebunan (Semi Permanen) 1
                                                    Lantai</option>
                                                <option value="43454_0">Rabat Beton (Semen Ekspose) - Bangunan Perkebunan
                                                    (Semi Permanen) 1 Lantai</option>
                                                <option value="79155_0">Papan Kayu - Bangunan Perkebunan (Semi Permanen) 1
                                                    Lantai</option>
                                                <option value="209294_0">Plat Lantai Beton T = 8 cm - Bangunan Gudang 1
                                                    Lantai</option>
                                                <option value="244126_0">Plat Lantai Beton T = 10 cm - Bangunan Gudang 1
                                                    Lantai</option>
                                                <option value="278957_0">Plat Lantai Beton T = 12 cm - Bangunan Gudang 1
                                                    Lantai</option>
                                                <option value="346178_0">Plat Lantai Beton T = 15 cm - Bangunan Gudang 1
                                                    Lantai</option>
                                                <option value="401420_0">Plat Lantai Beton T = 18 cm - Bangunan Gudang 1
                                                    Lantai</option>
                                                <option value="411260_0">Granit/Homogenous Tile - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="247679_0">Karpet - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="256461_0">Keramik - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="511030_0">Marmer Lokal - Bangunan Gedung Bertingkat Rendah
                                                    3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="59522_0">Rabat Beton (Semen Ekspose) - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="400032_0">Parkit Jati - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="330320_0">Vynil - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                            </select>
                                        </div>
                                        <div style="flex: 1; margin-right: 10px;">
                                            <label>Bobot (%)</label>
                                            <input type="number" name="bobot_tipe-lantai-existing[]"
                                                class="form-control" placeholder="Masukkan bobot" min="0"
                                                max="100" step="0.01" required>
                                        </div>
                                        <div class="area-controls">
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2"
                                id="show-tipe-lantai-existing-btn">Tambah Tipe Rangka Atap Existing</button>
                        </div>
    ...
    `;
                    ...
                    <div id="form-rumah-menengah" style=" margin-top: 20px; display: none;">
                        <div class="form-group" style="margin-top: 20px;">
                            <label for="jenis_bangunan" style="font-weight: bold;">Jenis Bangunan (Umur
                                Ekonomis)</label>
                            <br>
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            ...
                            <select class="form-control" id="jenis_bangunan_indeks_lantai"
                                ...
                                <option value="Bangunan Gedung Bertingkat Low Rise">Bangunan Gedung Bertingkat Low Rise
                                    (&lt;5 Lantai) (Low-Rise Building &lt;5 Floors)</option>
                                <option value="Bangunan Gedung Bertingkat Mid Rise">Bangunan Gedung Bertingkat Mid Rise
                                    (&lt;9 Lantai) (Mid-Rise Building &lt;9 Floors)</option>
                                <option value="Bangunan Gedung Bertingkat High Rise">Bangunan Gedung Bertingkat High Rise
                                    (&gt;8 Lantai) (High-Rise Building &gt;8 Floors)</option>
                            </select>
                        </div>
                        <div class="form-group" style="margin-top: 20px;">
                            <label for="tahun_dibangun" style="font-weight: bold;">Tahun Dibangun</label>
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            <label for="kondisi_visual" style="font-weight: bold;">Kondisi Bangunan Secara
                                Visual</label>
                            <select class="form-control" id="kondisi_visual" name="kondisi_visual">
                                <option value="">- Select -</option>
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            ...
                            <small class="form-text text-muted">Terpotong atau alasannya lainnya.</small>
                            <input type="number" class="form-control" id="luas_bangunan_terpotong"
                                name="luas_bangunan_terpotong" placeholder="Enter Area" min="0"
                                step="0.01">
                        </div>
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            <label for="luas_bangunan_imb" style="font-weight: bold;">Luas Bangunan menurut IMB
                                (m²)</label>
                            <input type="number" class="form-control" id="luas_bangunan_imb"
                                name="luas_bangunan_imb" placeholder="Enter Area" min="0" step="0.01">
                        </div>
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            <label><b>Luas Pintu dan Jendela</b></label><br>
                            <small class="form-text text-muted">Masukkan luas pintu dan jendela yang ada.</small>
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div id="bobot_pondasi_batu_kali" style="display: none; margin-top: 10px;">
                                <label for="bobot_batu_kali">Bobot Pondasi Batu Kali (dalam persen %)</label>
                                <input type="number" class="form-control" id="bobot_batu_kali"
                                    name="bobot_batu_kali" placeholder="Masukkan bobot dalam persen" min="0"
                                    max="100" step="0.01">
                            </div>
                        </div>
                        <div class="form-group mb-3" style="margin-top: 20px;">
                                ...
                                <div class="area-lainnya-container" data-type="pondasi">
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_pondasi[]" class="form-control" required>
                                                <option value="">- Select -</option>
                                                <option value="Tapak Beton dan Batu Kali - Rumah Tinggal Mewah 2 Lantai">
                                                    Tapak Beton dan Batu Kali - Rumah Tinggal Mewah 2 Lantai</option>
                                                <option
                                                    value="Tapak Beton dan Batu Kali - Rumah Tinggal Menengah 2 Lantai">
                                                    Tapak Beton dan Batu Kali - Rumah Tinggal Menengah 2 Lantai</option>
                                                <option value="Batu Kali - Rumah Tinggal Menengah 2 Lantai">Batu Kali -
                                                    Rumah Tinggal Menengah 2 Lantai</option>
                                                <option
                                                    value="Rollag Bata - Bangunan Perkebunan (Semi Permanen) 1 Lantai">
                                                    Rollag Bata - Bangunan Perkebunan (Semi Permanen) 1 Lantai</option>
                                                <option value="Tapak Beton dan Batu Kali - Bangunan Gudang 1 Lantai">Tapak
                                                    Beton dan Batu Kali - Bangunan Gudang 1 Lantai</option>
                                                <option
                                                    value="Tapak Beton dan Batu Kali - Bangunan Gedung Bertingkat Rendah 3 Lantai (< 5 Lantai)">
                                                    Tapak Beton dan Batu Kali - Bangunan Gedung Bertingkat Rendah 3 Lantai (
                                                    < 5 Lantai)</option>
                                            </select>
                                        </div>
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2" id="show-pondasi-btn">Tambah
                            ...
                            <div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="Beton Bertulang"
                                        id="struktur_beton_bertulang"
                                        onchange="toggleBobotInput(this, 'bobot_struktur_beton_bertulang')">
                                    <label class="form-check-label" for="struktur_beton_bertulang">Beton
                                        Bertulang</label>
                                </div>
                            </div>
                            <div id="bobot_struktur_beton_bertulang" style="display: none; margin-top: 10px;">
                                <label for="bobot_beton_bertulang">Bobot Struktur Beton Bertulang (dalam persen %)</label>
                                <input type="number" class="form-control" id="bobot_beton_bertulang"
                                    name="bobot_beton_bertulang" placeholder="Masukkan bobot dalam persen"
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2" id="show-struktur-btn">Tambah
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                            ...
                            <div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                        value="Dak Beton (Jika Pakai Balok)" id="atap_dak_beton">
                                    <label class="form-check-label" for="atap_dak_beton">Dak Beton (Jika Pakai
                                        Balok)</label>
                                </div>
                                <div class="form-check">
                        ...
                        <div class="form-group mb-3" style="margin-top: 20px;">
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_rangka_atap[]" class="form-control" required>
                                                ...
                                                <option value="124221_1">Dak Beton (Jika Pakai Balok) - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="252610_1">Kayu (Atap Genteng) - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="147623_1">Kayu (Atap Asbes, Seng dll, Tanpa Reng) - Rumah
                                                    Tinggal Menengah 2 Lantai</option>
                                                <option value="214587_1">Baja Ringan (Atap Genteng) - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="173204_1">Baja Ringan (Atap Asbes, Seng dll) - Rumah
                                                    Tinggal Menengah 2 Lantai</option>
                                                <option value="78577_1">Kayu (Atap Asbes, Seng dll, Tanpa Reng) - Bangunan
                                                    Perkebunan (Semi Permanen) 1 Lantai</option>
                                                <option value="339006_1">Profil Baja - Bangunan Gudang 1 Lantai</option>
                                                <option value="112308_0.335">Dak Beton (Jika Pakai Balok) - Bangunan
                                                    Gedung Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.3002_0.335">Kayu (Atap Genteng) - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.3003_0.335">Kayu (Atap Asbes, Seng dll, Tanpa Reng) -
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2"
                                id="show-rangka-atap-btn">Tambah Tipe Rangka Atap Existing</button>
                        </div>

                        <div class="form-group mb-3" style="margin-top: 20px;">
                            <label><strong>Tipe Penutup Atap Eksisting - Rumah Tinggal Menengah 2
                                    Lantai</strong></label><br>
                            <input type="checkbox" id="asbes" name="tipe_atap" value="Asbes"
                                class="form-check-input">
                            <label for="asbes" class="form-check-label">Asbes</label><br>
                            ...
                            <input type="checkbox" id="genteng-tanah-liat" name="tipe_atap"
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_penutup-atap-existing[]" class="form-control" required>
                                                ...
                                                <option value="276586_0.5028">Sirap - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="148318_0.5028">Spandek - Rumah Tinggal Mewah 2 Lantai
                                                </option>
                                                <option value="262711_0.5028">PVC - Rumah Tinggal Mewah 2 Lantai</option>
                                                ...
                                                <option value="160060_0.5569">Genteng Keramik Glazur - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="106213_0.5569">Genteng Tanah Liat - Rumah Tinggal Menengah
                                                    2 Lantai</option>
                                                <option value="151664_0.5569">Genteng Beton - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="146988_0.5569">Genteng Metal - Rumah Tinggal Menengah 2
                                                ...
                                                <option value="304700_1">Dak Beton - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="234491_1">Fibreglass - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="156035_1">Genteng Tanah Liat - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="200470_1">Genteng Beton - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="202741_1">Genteng Metal - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="130168_1">Seng Gelombang - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="124692_1">Spandek - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                ...
                                                <option value="124275_1">Seng Gelombang - Bangunan Perkebunan (Semi
                                                    Permanen) 1 Lantai</option>
                                                <option value="91072_1">Asbes - Bangunan Gudang 1 Lantai</option>
                                                <option value="100790_1">Seng Gelombang - Bangunan Gudang 1 Lantai
                                                </option>
                                                <option value="95320_1">Spandek - Bangunan Gudang 1 Lantai</option>
                                                <option value="0.4001_0.335">Asbes - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="191376_0.335">Dak Beton - Bangunan Gedung Bertingkat Rendah
                                                    3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4003_0.335">Fibreglass - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4004_0.335">Genteng Keramik Glazur - Bangunan Gedung
                                                    Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4005_0.335">Genteng Tanah Liat - Bangunan Gedung
                                                ...
                                                <option value="4007_0.335">Genteng Metal - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4008_0.335">Bitumen (Ondulin/ Onduvilla) - Bangunan
                                                    Gedung Bertingkat Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.401_0.335">Tegola - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="0.4011_0.335">Seng Gelombang - Bangunan Gedung Bertingkat
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_tipe-dinding-existing[]" class="form-control" required>
                                                ...
                                                <option value="289328_2.143">Partisi Gypsumboard 2 Muka - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="703318_2.143">Rooster Bata - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="153906_2.169">Batako - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="190474_2.169">Bata Merah - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="207182_2.169">Bata Ringan - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="260248_2.169">Partisi Gypsumboard 2 Muka - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="605463_2.169">Rooster Bata - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="336877_1.481">Papan dan Partisi Triplek Dicat - Bangunan
                                                    Perkebunan (Semi Permanen) 1 Lantai</option>
                                                <option value="113213_1.249">Batako - Bangunan Gudang 1 Lantai</option>
                                                <option value="142562_1.249">Bata Merah - Bangunan Gudang 1 Lantai
                                                </option>
                                                <option value="147222_1.249">Bata Ringan - Bangunan Gudang 1 Lantai
                                                </option>
                                                <option value="226702_1.249">Dinding Spandek Rangka Baja - Bangunan Gudang
                                                ...
                                                <option value="142987_1.577">Batako - Bangunan Gedung Bertingkat Rendah 3
                                                    Lantai (&lt; 5 Lantai)</option>
                                                <option value="180055_1.577">Bata Merah - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="185940_1.577">Bata Ringan - Bangunan Gedung Bertingkat
                                                    Rendah 3 Lantai (&lt; 5 Lantai)</option>
                                                <option value="212891_1.577">Partisi Gypsumboard 2 Muka - Bangunan Gedung
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_tipe-pelapis-dinding-existing[]" class="form-control"
                                                ...
                                                <option value="332768_2.169">Dilapis Cat (Diplester dan Diaci) - Rumah
                                                    Tinggal Menengah 2 Lantai</option>
                                                <option value="782252_2.169">Dilapis Keramik - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="642040_2.169">Dilapis Wallpaper - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="1828812_2.169">Dilapis Mozaik - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="856559_2.169">Dilapis Batu Alam - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="194807_1.249">Dilapis Cat (Diplester dan Diaci) - Bangunan
                                                    Gudang 1 Lantai</option>
                                                <option value="345190_1.577">Dilapis Cat (Diplester dan Diaci) - Bangunan
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_tipe-pintu-jendela-existing[]" class="form-control"
                                                ...
                                                <option value="130977_0.218">Jendela Kaca Tempered Frameless - Rumah
                                                    Tinggal Menengah 2 Lantai</option>
                                                <option value="305534_0.327">Pintu Kayu Panil - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="236730_0.327">Pintu Kayu Dobel Triplek/ HPL - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="311178_0.327">Pintu Kaca Rk Aluminium - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="265053_0.327">Jendela Kaca Rk Kayu - Rumah Tinggal Menengah
                                                    2 Lantai</option>
                                                <option value="316582_0.327">Jendela Kaca Rk Aluminium - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                <option value="65494_0.327">Pintu KM UPVC/PVC - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="71764_0.276">Jendela Kaca Rk Kayu - Bangunan Perkebunan
                                                    (Semi Permanen) 1 Lantai</option>
                                                <option value="74470_0.057">Pintu Besi - Bangunan Gudang 1 Lantai</option>
                                    ...
                                    <div class="area-item d-flex align-items-center mb-2">
                                        <div style="flex: 1; margin-right: 10px;">
                                            ...
                                            <select name="tipe_tipe-lantai-existing[]" class="form-control" required>
                                                ...
                                                <option value="260164_0">Granit/Homogenous Tile - Rumah Tinggal Menengah 2
                                                    Lantai</option>
                                                <option value="173280_0">Karpet - Rumah Tinggal Menengah 2 Lantai</option>
                                                <option value="176287_0">Keramik - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="66156_0">Rabat Beton (Semen Ekspose) - Rumah Tinggal
                                                    Menengah 2 Lantai</option>
                                                ...
                                                <option value="102937_0">Papan Kayu - Rumah Tinggal Menengah 2 Lantai
                                                </option>
                                                <option value="150353_0">Keramik - Bangunan Perkebunan (Semi Permanen) 1
                                                    Lantai</option>
                                                <option value="43454_0">Rabat Beton (Semen Ekspose) - Bangunan Perkebunan
    ...
    `;
                            ...
                            document.querySelectorAll('.add-area-link').forEach(function(button) {
                                button.addEventListener('click', function(e) {
                                    ...
                                    const type = this.getAttribute('data-type');
                                    const areaContainer = document.querySelector(
                                        `.area-lainnya-container[data-type="${type}"]`);
                                    const newAreaItem = createAreaItem(type);
                                    areaContainer.appendChild(newAreaItem);
                                });
                            });
                    ...
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const showRangkaAtapBtn = document.getElementById('show-tipe-pelapis-dinding-existing-btn');
                            const addRangkaAtapBtn = document.querySelector(
                                '.add-area-link[data-type="tipe-pelapis-dinding-existing"]');
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const showRangkaAtapBtn = document.getElementById('show-tipe-pintu-jendela-existing-btn');
                            const addRangkaAtapBtn = document.querySelector(
                                '.add-area-link[data-type="tipe-pintu-jendela-existing"]');
