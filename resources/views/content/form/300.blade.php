    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div class="area-lainnya-container-300" data-type="dinding-300">
            <div class="area-item d-flex align-items-center mb-2">
                <div style="flex: 1; margin-right: 10px;">
                    <label>Nama Area</label>
                    <input type="text" name="nama_dinding-300[]" class="form-control" placeholder="Nama Area"
                        required>
                </div>
                <div style="flex: 1; margin-right: 10px;">
                    <label>Luas (m²)</label>
                    <input type="number" name="luas_dinding-300[]" class="form-control" placeholder="Luas (m²)"
                        min="0" step="0.01" required>
                </div>
                <div class="area-controls">
                    <div class="row">
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div class="area-lainnya-container-300" data-type="atap-datar-300">
            <div class="area-item d-flex align-items-center mb-2">
                <div style="flex: 1; margin-right: 10px;">
                    <label>Nama Area</label>
                    <input type="text" name="nama_atap_datar-300[]" class="form-control" placeholder="Nama Area"
                        required>
                </div>
                <div style="flex: 1; margin-right: 10px;">
                    <label>Luas (m²)</label>
                    <input type="number" name="luas_atap_datar-300[]" class="form-control" placeholder="Luas (m²)"
                        min="0" step="0.01" required>
                </div>
                <div class="area-controls">
                    <div class="row">
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div class="area-lainnya-container-300" data-type="atap-datar-300-2">
            <div class="area-item d-flex align-items-center mb-2">
                <div style="flex: 1; margin-right: 10px;">
                    <label>Nama Area</label>
                    <input type="text" name="nama_atap_datar-300_2[]" class="form-control" placeholder="Nama Area"
                        required>
                </div>
                <div style="flex: 1; margin-right: 10px;">
                    <label>Luas (m²)</label>
                    <input type="number" name="luas_atap_datar-300_2[]" class="form-control" placeholder="Luas (m²)"
                        min="0" step="0.01" required>
                </div>
                <div class="area-controls">
                    <div class="row">
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="Batu Kali" id="pondasi_batu_kali_300"
        ...
        <div id="bobot_pondasi_batu_kali_menengah-300" style="display: none; margin-top: 10px;">
            ...
            <input type="number" class="form-control" id="bobot_batu_kali_300" name="bobot_batu_kali_300"
            ...
            <div class="area-lainnya-container-300" data-type="pondasi_300">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        ...
                        <select name="tipe_pondasi_300[]" class="form-control" required>
                    ...
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Bobot (%)</label>
                        <input type="number" name="bobot_pondasi_300[]" class="form-control"
        ...
        <div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="Beton Bertulang"
                    id="struktur_beton_bertulang_300"
        ...
        <div id="struktur-container-300" style="display: none;">
            <div class="area-lainnya-container-300" data-type="struktur_300">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_struktur_300[]" class="form-control" required>
                            <option value="">- Select -</option>
                    ...
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Bobot (%)</label>
                        <input type="number" name="bobot_struktur_300[]" class="form-control"
                            placeholder="Masukkan bobot" min="0" max="100" step="0.01" required>
                    </div>
                    <div class="area-controls">
                        <div class="row">
        ...
        <div>
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="Baja Ringan (Atap Asbes, Seng dll)"
                    id="atap_baja_asbes_300">
                <label class="form-check-label" for="atap_baja_asbes_300">Baja Ringan (Atap Asbes, Seng
                    dll)</label>
            </div>
        </div>
    </div>
        ...
        <div id="rangka-atap-container-300" style="display: none;">
            <div class="area-lainnya-container-300" data-type="rangka-atap-300">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_rangka_atap_300[]" class="form-control" required>
                            <option value="">- Select -</option>
        ...
        <div id="penutup-atap-existing-300-container" style="display: none;">
            <div class="area-lainnya-container-300" data-type="penutup-atap-existing-300">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_penutup-atap-existing-300[]" class="form-control" required>
        ...
        <div id="plafon-existing-300-container" style="display: none;">
            <div class="area-lainnya-container-300" data-type="plafon-existing-300">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_plafon-existing-300[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
        ...
        <div id="dinding-existing-300-container" style="display: none;">
            <div class="area-lainnya-container-300" data-type="dinding-existing-300">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_dinding-existing-300[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
        ...
        <div id="tipe-pelapis-dinding-existing-300-container" style="display: none;">
            <div class="area-lainnya-container-300" data-type="tipe-pelapis-dinding-existing-300">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_tipe-pelapis-dinding-existing-300[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
        ...
        <div id="tipe-pintu-jendela-existing-300-container" style="display: none;">
            <div class="area-lainnya-container-300" data-type="tipe-pintu-jendela-existing-300">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_tipe-pintu-jendela-existing-300[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
        ...
        <div id="tipe-lantai-existing-300-container" style="display: none;">
            <div class="area-lainnya-container-300" data-type="tipe-lantai-existing-300">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_tipe-lantai-existing-300[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
