...
<div id="300" style="margin-top: 20px; display: none;">
    ...
    <div class="form-group" style="margin-top: 20px;">
        ...
        <select class="form-control" id="tahun_dibangun" name="tahun_dibangun"
            onchange="toggleCheckboxes300(this, 'checkboxContainerDibangun300')">
            <script>
                const currentYear300 = new Date().getFullYear();
                const startYear300 = 1900;
                const endYear300 = currentYear300 + 7;
                let options300 = '';

                for (let year = startYear300; year <= endYear300; year++) {
                    const selected = year === currentYear300 ? 'selected' : '';
                    options300 += `<option value="${year}" ${selected}>${year}</option>`;
                }
                document.write(options300);
            </script>
        </select>
    </div>

    <div id="checkboxContainerDibangun300" style="display: none; margin-top: 20px;">
    ...
    <div class="form-group" style="margin-top: 20px;">
        ...
        <select class="form-control" id="tahun_renovasi" name="tahun_renovasi"
            onchange="toggleCheckboxes300(this, 'checkboxContainerRenovasi300')">
            <script>
                const startYearRenovasi300 = 1960;
                const endYearRenovasi300 = currentYear300 + 7;
                let optionsRenovasi300 = '';

                for (let year = startYearRenovasi300; year <= endYearRenovasi300; year++) {
                    const selected = year === currentYear300 ? 'selected' : '';
                    optionsRenovasi300 += `<option value="${year}" ${selected}>${year}</option>`;
                }

                document.write(optionsRenovasi300);
            </script>
        </select>
    </div>

    <div id="checkboxContainerRenovasi300" style="display: none; margin-top: 20px;">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-8">
                <div class="canvas-container bg-white">
                    <canvas id="drawingCanvas_300" width="800" height="600"></canvas>
                ...
                <div class="tools-container">
                    ...
                    <div class="nav-controls mb-3">
                        <div class="d-flex justify-content-center">
                            <div class="nav-button-group">
                                <button type="button" class="nav-btn" onclick="setDirection_300('up')">
                                    <i class="fas fa-chevron-up"></i>
                                </button>
                                <div class="d-flex">
                                    <button type="button" class="nav-btn" onclick="setDirection_300('left')">
                                        <i class="fas fa-chevron-left"></i>
                                    </button>
                                    <button type="button" class="nav-btn" onclick="setDirection_300('down')">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                    <button type="button" class="nav-btn" onclick="setDirection_300('right')">
                    ...
                    <div class="measurement-inputs">
                        <div class="input-group mb-3">
                            ...
                            <input type="number" id="distance_300" class="form-control" placeholder="Jarak (m)">
                        </div>
                        <div class="input-group mb-4">
                            <span class="input-group-text">
                                <i class="fas fa-drafting-compass"></i>
                            </span>
                            <input type="number" id="angle_300" class="form-control" placeholder="Sudut (°)">
                        </div>
                    </div>

                    <!-- Action Buttons -->
                    <div class="action-buttons mb-4">
                        <button type="button" class="btn btn-primary w-100 mb-2" onclick="drawLine_300()">
                            <i class="fas fa-pen me-2"></i>Gambar Garis
                        </button>
                        <button type="button" class="btn btn-success w-100 mb-2" onclick="closePolygon_300()">
                            <i class="fas fa-vector-square me-2"></i>Tutup Area
                        </button>
                        <button type="button" class="btn btn-outline-danger w-100" onclick="clearCanvas_300()">
                    ...
                    <div class="form-fields">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_lantai_300[]"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="btn-group w-100" role="group">
                                <input type="radio" class="btn-check" name="faktor_pengali_300[]"
                                    id="pengali_1_300" value="1" checked>
                                <label class="btn btn-outline-primary" for="pengali_1_300">1.0</label>
                                <input type="radio" class="btn-check" name="faktor_pengali_300[]"
                                    id="pengali_0.5_300" value="0.5">
                                <label class="btn btn-outline-primary" for="pengali_0.5_300">0.5</label>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="luas_bangunan_300[]" placeholder="0"
                                step="0.01" readonly>
                        </div>
                    </div>
                </div>
    ...
    <div class="mt-3">
        <button type="button" class="btn btn-primary" id="add-lantai-btn_300">
            <i class="fas fa-plus-circle me-2"></i>Tambah Lantai
        </button>
    </div>

    <div id="lantai-container-wrapper_300">
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <input type="checkbox" id="bata-ringan-dinding-300" name="tipe_tipe_dinding_existing[]"
            value="Bata Ringan" class="form-check-input">
...
<script>
    ...
    function toggleCheckboxes300(selectElement, targetId) {
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const mainCanvas = document.getElementById('drawingCanvas_300');
        if (mainCanvas) {
            // Set ukuran canvas sesuai dengan container
            resizeCanvas_300(mainCanvas);

            // Inisialisasi canvas utama di sini
            setupCanvas_300('drawingCanvas_300');
            ...
            redrawCanvas_300('drawingCanvas_300');
        }

        // Fungsi untuk menambahkan lantai baru
        const addLantaiBtn = document.getElementById('add-lantai-btn_300');
        if (addLantaiBtn) {
            addLantaiBtn.addEventListener('click', function() {
                        ...
                        <div class="col-md-4">
                            <div class="tools-container">
                                ...
                                <div class="nav-controls mb-3">
                                    <div class="d-flex justify-content-center">
                                        <div class="nav-button-group">
                                            <button type="button" class="nav-btn" onclick="setDirection_300('up', '${uniqueId}')">
                                                <i class="fas fa-chevron-up"></i>
                                            </button>
                                            <div class="d-flex">
                                                <button type="button" class="nav-btn" onclick="setDirection_300('left', '${uniqueId}')">
                                                    <i class="fas fa-chevron-left"></i>
                                                </button>
                                                <button type="button" class="nav-btn" onclick="setDirection_300('down', '${uniqueId}')">
                                                    <i class="fas fa-chevron-down"></i>
                                                </button>
                                                <button type="button" class="nav-btn" onclick="setDirection_300('right', '${uniqueId}')">
                                                    <i class="fas fa-chevron-right"></i>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <!-- Action Buttons -->
                                <div class="action-buttons mb-4">
                                    <button type="button" class="btn btn-primary w-100 mb-2" onclick="drawLine_300('${uniqueId}')">
                                        <i class="fas fa-pen me-2"></i>Gambar Garis
                                    </button>
                                    <button type="button" class="btn btn-success w-100 mb-2" onclick="closePolygon_300('${uniqueId}')">
                                        <i class="fas fa-vector-square me-2"></i>Tutup Area
                                    </button>
                                    <button type="button" class="btn btn-outline-danger w-100" onclick="clearCanvas_300('${uniqueId}')">
                                        <i class="fas fa-undo me-2"></i>Hapus Garis Terakhir
                                    </button>
                                </div>
                                ...
                                <div class="form-fields">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="faktor_pengali_300[]" value="1" class="pengali-value-${uniqueId}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="luas_bangunan_300[]" id="luas_${uniqueId}" 
                ...
                const wrapper = document.getElementById('lantai-container-wrapper_300');
                if (wrapper) {
                ...
                setTimeout(() => {
                    ...
                    if (newCanvas) {
                        ...
                        setupCanvas_300(uniqueId);

                        // Gambar canvas awal
                        redrawCanvas_300(uniqueId);
                    }
                }, 100);
    ...
    function resizeCanvas_300(canvas) {
    ...
    function drawPoint_300(x, y, ctx) {
        ctx.beginPath();
    ...
    function drawMeasurement_300(startX, startY, endX, endY, distance, ctx, zoom = 1) {
    ...
    function calculateArea_300(canvasId = 'drawingCanvas_300') {
        let currentPoints;
        let currentScale;
        let currentZoom;

        if (canvasId === 'drawingCanvas_300') {
    ...
    function setupCanvas_300(canvasId) {
        ...
        window.addEventListener('resize', function() {
            resizeCanvas_300(canvas);
            redrawCanvas_300(canvasId);
        });
    }

    // Fungsi untuk menggambar ulang canvas dengan perbaikan
    function redrawCanvas_300(canvasId = 'drawingCanvas_300') {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return;
        ...
        drawGrid_300(ctx, canvas.width, canvas.height, currentZoom, currentOffsetX, currentOffsetY, currentScale);
        ...
        for (let i = 0; i < currentPoints.length; i++) {
            ...
            if (i > 0) {
                ...
                drawMeasurement_300(currentPoints[i - 1].x, currentPoints[i - 1].y,
        ...
        if (isAreaClosed) {
            const area = calculateArea_300(canvasId);
            ...
            const luasInput = canvasId === 'drawingCanvas_300' ?
                document.querySelector('input[name="luas_bangunan_300[]"]') :
    ...
    function drawGrid_300(ctx, width, height, zoom, offsetX, offsetY, gridSize) {
    ...
    function setDirection_300(direction, canvasId = 'drawingCanvas_300') {
        const distanceInput = document.getElementById(canvasId === 'drawingCanvas_300' ? 'distance_300' :
            `distance_${canvasId}`);
        const angleInput = document.getElementById(canvasId === 'drawingCanvas_300' ? 'angle_300' :
            `angle_${canvasId}`);
    ...
    function startPan_300(e, canvasId = 'drawingCanvas_300') {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return;
    ...
    function pan_300(e, canvasId = 'drawingCanvas_300') {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return;
    ...
    function endPan_300(canvasId = 'drawingCanvas_300') {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return;
    ...
    function drawLine_300(canvasId = 'drawingCanvas_300') {
        const distanceInput = document.getElementById(canvasId === 'drawingCanvas_300' ? 'distance_300' :
            `distance_${canvasId}`);
        const angleInput = document.getElementById(canvasId === 'drawingCanvas_300' ? 'angle_300' :
            `angle_${canvasId}`);
    ...
    function closePolygon_300(canvasId = 'drawingCanvas_300') {
        // Dapatkan data untuk canvas yang sesuai
        let currentPoints;
    ...
    function clearCanvas_300(canvasId = 'drawingCanvas_300') {
        // Dapatkan data untuk canvas yang sesuai
        let currentPoints;
        ...
        if (formElements.length > 0) {
            formElements.forEach(form => {
                form.addEventListener('submit', function(e) {
                    ...
                    const canvasDataToSave = getCanvasData_300();
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if (isset($bangunan->canvas_data) && $bangunan->tipe_spek === '200')
            ...
            if (savedData.main) {
                ...
                // Redraw canvas utama
                if (document.getElementById('drawingCanvas_300')) {
                    redrawCanvas_300('drawingCanvas_300');
                    ...
                    if (points.length > 3 &&
                        points[0].x === points[points.length - 1].x &&
                        points[0].y === points[points.length - 1].y) {
                        const area = calculateArea_300('drawingCanvas_300');
                        const luasBangunanInput = document.querySelector('input[name="luas_bangunan_300[]"]');
