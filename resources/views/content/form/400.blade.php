...
<div id="400" style=" margin-top: 20px; display: none;">
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div class="area-lainnya-container-400" data-type="atap-datar-400-2">
            <div class="area-item d-flex align-items-center mb-2">
                <div style="flex: 1; margin-right: 10px;">
                    <label>Nama Area</label>
                    <input type="text" name="nama_atap_datar-400_2[]" class="form-control" placeholder="Nama Area"
                        required>
                </div>
                <div style="flex: 1; margin-right: 10px;">
                    <label>Luas (m²)</label>
                    <input type="number" name="luas_atap_datar-400_2[]" class="form-control" placeholder="Luas (m²)"
                        min="0" step="0.01" required>
                </div>
                <div class="area-controls">
                    <div class="row">
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div id="pondasi-container-400" style="display: none;">
            <div class="area-lainnya-container-400" data-type="pondasi_400">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        ...
                        <select name="tipe_pondasi_400[]" class="form-control" required>
            ...
            <button type="button" class="btn btn-primary btn-sm mt-2 add-area-link"
                data-type="pondasi_400">Tambah Tipe Pondasi Existing</button>
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="Kayu"
                    id="struktur_beton_bertulang_400"
        ...
        <div id="struktur-container-400" style="display: none;">
            <div class="area-lainnya-container-400" data-type="struktur_400">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_struktur_400[]" class="form-control" required>
                            <option value="">- Select -</option>
            ...
            <button type="button" class="btn btn-primary btn-sm mt-2 add-area-link"
                data-type="struktur_400">Tambah Tipe Struktur Existing</button>
        </div>
        ...
        <div id="rangka-atap-container-400" style="display: none;">
            <div class="area-lainnya-container-400" data-type="rangka-atap-400">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_rangka_atap_400[]" class="form-control" required>
                            <option value="">- Select -</option>
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div id="penutup-atap-existing-400-container" style="display: none;">
            <div class="area-lainnya-container-400" data-type="penutup-atap-existing-400">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_penutup-atap-existing-400[]" class="form-control" required>
        ...
        <button type="button" class="btn btn-primary btn-sm mt-2"
            id="show-penutup-atap-existing-400-btn">Tambah Tipe
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div id="plafon-existing-400-container" style="display: none;">
            <div class="area-lainnya-container-400" data-type="plafon-existing-400">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_plafon-existing-400[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
        ...
        <button type="button" class="btn btn-primary btn-sm mt-2"
            id="show-plafon-existing-400-btn">Tambah Plafon Existing</button>
    </div>
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <input type="checkbox" id="papan-partisi-triplek-dicat-dinding-400" name="tipe_dinding" value="Papan dan Partisi Triplek Dicat" class="form-check-input">
        <label for="papan-partisi-triplek-dicat-dinding-400" class="form-check-label">Papan dan Partisi Triplek Dicat</label><br>
    </div>
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div id="dinding-existing-400-container" style="display: none;">
            <div class="area-lainnya-container-400" data-type="dinding-existing-400">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_dinding-existing-400[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
        ...
        <button type="button" class="btn btn-primary btn-sm mt-2"
            id="show-dinding-existing-400-btn">Tambah Tipe Dinding Existing</button>
    </div>
        ...
        <div id="tipe-pelapis-dinding-existing-400-container" style="display: none;">
            <div class="area-lainnya-container-400" data-type="tipe-pelapis-dinding-existing-400">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_tipe-pelapis-dinding-existing-400[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
                    ...
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Bobot (%)</label>
                        <input type="number" name="bobot_tipe-pelapis-dinding-existing-400[]"
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        <label><strong>Tipe Pintu & Jendela Eksisting - Bangunan Perkebunan (Semi Permanen) 1 Lantai</strong></label><br>

        <input type="checkbox" id="pintu-kayu-dobel-400" name="tipe_pintu_jendela" value="Pintu Kayu Dobel Triplek/HPL" class="form-check-input">
        <label for="pintu-kayu-dobel-400" class="form-check-label">Pintu Kayu Dobel Triplek/HPL</label><br>


        <input type="checkbox" id="jendela-kaca-kayu-400" name="tipe_pintu_jendela" value="Jendela Kaca Rk Kayu" class="form-check-input">
        ...
        <div id="tipe-pintu-jendela-existing-400-container" style="display: none;">
            <div class="area-lainnya-container-400" data-type="tipe-pintu-jendela-existing-400">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_tipe-pintu-jendela-existing-400[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
                    ...
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Bobot (%)</label>
                        <input type="number" name="bobot_tipe-pintu-jendela-existing-400[]"
                            class="form-control" placeholder="Masukkan bobot" min="0" max="100"
                            step="0.01" required>
                    </div>
                    <div class="area-controls">
    ...
    <div class="form-group mb-3" style="margin-top: 20px;">
        ...
        <div id="tipe-lantai-existing-400-container" style="display: none;">
            <div class="area-lainnya-container-400" data-type="tipe-lantai-existing-400">
                <div class="area-item d-flex align-items-center mb-2">
                    <div style="flex: 1; margin-right: 10px;">
                        <label>Tipe Material</label>
                        <select name="tipe_tipe-lantai-existing-400[]" class="form-control" required>
                            <option value="" selected="selected" data-i="0">- Select -
                            </option>
        ...
        <button type="button" class="btn btn-primary btn-sm mt-2"
            id="show-tipe-lantai-existing-400-btn">Tambah Tipe
