...
<div id="1100" style=" margin-top: 20px; display: none;">
    <div class="form-group" style="margin-top: 20px;">
        <label for="grade_gedung" style="font-weight: bold;">Pilih Grade Apartemen</label>
        <select class="form-control" id="grade_gedung" name="grade_gedung">
            <option value="" selected>- Select -</option>
            <option value="grade_b" selected="selected" data-i="0">Apartemen Grade B</option>
            <option value="grade_a">Apartemen Grade A</option>
        </select>
    </div>

    <div class="form-group" style="margin-top: 20px;">
        <label for="jenis_bangunan_1100" style="font-weight: bold;">Jenis Bangunan (Umur Ekonomis)</label>
        <br>
        <small class="form-text text-muted">Pilih jenis bangunan yg sesuai untuk menentukan umur ekonomis
            bangunan.</small>
        <select class="form-control" id="jenis_bangunan_1100" name="jenis_bangunan_1100">
            <option value="" selected>- Select -</option>
            <option value="rumah_tinggal_1100">Bangunan Rumah Tinggal</option>
            <option value="rumah_susun_1100">Bangunan Rumah Susun</option>
            <option value="pusat_perbelanjaan_1100">Bangunan Pusat Perbelanjaan</option>
            <option value="kantor_1100">Bangunan Kantor</option>
            <option value="gedung_pemerintah_1100">Bangunan Gedung Pemerintah</option>
            <option value="hotel_motel_1100">Bangunan Hotel/Motel</option>
            <option value="industri_gudang_1100">Bangunan Industri dan Gudang</option>
            <option value="kawasan_perkebunan_1100">Bangunan di Kawasan Perkebunan</option>
        </select>
    </div>

    <!-- Jenis Bangunan Detail -->
    <div style="margin-top: 20px;">
        <div id="detail_rumah_tinggal_1100" class="bangunan-detail-1100" style="display: none;">
        ...
        <div id="detail_rumah_susun_1100" class="bangunan-detail-1100" style="display: none;">
        ...
        <div id="detail_pusat_perbelanjaan_1100" class="bangunan-detail-1100" style="display: none;">
        ...
        <div id="detail_kantor_1100" class="bangunan-detail-1100" style="display: none;">
        ...
        <div id="detail_gedung_pemerintah_1100" class="bangunan-detail-1100" style="display: none;">
        ...
        <div id="detail_hotel_motel_1100" class="bangunan-detail-1100" style="display: none;">
        ...
        <div id="detail_industri_gudang_1100" class="bangunan-detail-1100" style="display: none;">
        ...
        <div id="detail_kawasan_perkebunan_1100" class="bangunan-detail-1100" style="display: none;">
    ...
    <script>
        document.getElementById('jenis_bangunan_1100').addEventListener('change', function() {
            // Sembunyikan semua detail
            document.querySelectorAll('.bangunan-detail-1100').forEach(el => el.style.display = 'none');
    ...
    <div class="form-group" style="margin-top: 20px;">
        <label for="jenis_bangunan_indeks_lantai_1100" style="font-weight: bold;">Jenis Bangunan (Indeks
            Lantai)</label>
        <br>
        <small class="form-text text-muted">Pilih jenis bangunan yg sesuai untuk menentukan indeks lantai
            MAPPI.</small>
        <select class="form-control" id="jenis_bangunan_indeks_lantai_1100" name="jenis_bangunan_indeks_lantai_1100">
            <option value="" selected>- Select -</option>
            <option value="rumah_sederhana_1100">Rumah Tinggal Sederhana</option>
            <option value="rumah_menengah_1100">Rumah Tinggal Menengah</option>
            <option value="rumah_mewah_1100">Rumah Tinggal Mewah</option>
            <option value="gedung_low_1100">Bangunan Gedung Bertingkat Low Rise (&lt;5 Lantai)</option>
            <option value="gedung_mid_1100">Bangunan Gedung Bertingkat Mid Rise (&lt;9 Lantai)</option>
            <option value="gedung_high_1100">Bangunan Gedung Bertingkat High Rise (&gt;8 Lantai)</option>
        </select>
    </div>

    <!-- Jumlah Lantai sections -->
    <div style="margin-top: 20px;">
        <div id="detail_rumah_sederhana_1100" class="lantai-detail-1100" style="display: none; margin-top: 20px;">
            <label for="jumlah_lantai_rumah_sederhana_1100">Jumlah Lantai Rumah Tinggal Sederhana</label>
        ...
        <div id="detail_rumah_menengah_1100" class="lantai-detail-1100" style="display: none; margin-top: 20px;">
            <label for="jumlah_lantai_rumah_menengah_1100">Jumlah Lantai Rumah Tinggal Menengah</label>
            <select class="form-control" name="jumlah_lantai_rumah_tinggal[]">
                <option value="" selected>- Select -</option>
        ...
        <div id="detail_rumah_mewah_1100" class="lantai-detail-1100" style="display: none; margin-top: 20px;">
            <label for="jumlah_lantai_rumah_mewah_1100">Jumlah Lantai Rumah Tinggal Mewah</label>
            <select class="form-control" name="jumlah_lantai_rumah_tinggal[]">
                <option value="" selected>- Select -</option>
        ...
        <div id="detail_gedung_low_1100" class="lantai-detail-1100" style="display: none; margin-top: 20px;">
            <label for="jumlah_lantai_gedung_low_1100">Jumlah Lantai Bangunan Gedung Bertingkat Low Rise (&lt;5
                Lantai)</label>
            <select class="form-control" id="jumlah_lantai_gedung_low_1100" name="jumlah_lantai_rumah_tinggal[]">
                <option value="" selected>- Select -</option>
        ...
        <div id="detail_gedung_mid_1100" class="lantai-detail-1100" style="display: none; margin-top: 20px;">
            <label for="jumlah_lantai_gedung_mid_1100">Jumlah Lantai Bangunan Gedung Bertingkat Mid Rise (&lt;9
                Lantai)</label>
            <select class="form-control" id="jumlah_lantai_gedung_mid_1100" name="jumlah_lantai_rumah_tinggal[]">
                <option value="" selected>- Select -</option>
        ...
        <div id="detail_gedung_high_1100" class="lantai-detail-1100" style="display: none; margin-top: 20px;">
            <label for="jumlah_lantai_gedung_high_1100">Jumlah Lantai Bangunan Gedung Bertingkat High Rise (&gt;8
                Lantai)</label>
            <select class="form-control" id="jumlah_lantai_gedung_high_1100" name="jumlah_lantai_rumah_tinggal[]">
                <option value="" selected>- Select -</option>
    ...
    <script>
        document.getElementById('jenis_bangunan_indeks_lantai_1100').addEventListener('change', function() {
            // Sembunyikan semua detail
            document.querySelectorAll('.lantai-detail-1100').forEach(el => el.style.display = 'none');
    ...
    <div class="form-group" style="margin-top: 20px;">
        <label for="tahun_dibangun_1100" style="font-weight: bold;">Tahun Dibangun</label>
        <select class="form-control" id="tahun_dibangun_1100" name="tahun_dibangun_1100"
            onchange="toggleCheckboxes1100(this, 'checkboxContainerDibangun1100')">
            <script>
                const currentYear1100 = new Date().getFullYear();
                const startYear1100 = 1900;
                const endYear1100 = currentYear1100 + 7;
                let options1100 = '';

                for (let year = startYear1100; year <= endYear1100; year++) {
                    const selected = year === currentYear1100 ? 'selected' : '';
                    options1100 += `<option value="${year}" ${selected}>${year}</option>`;
                }
                document.write(options1100);
            </script>
        </select>
    </div>

    <div id="checkboxContainerDibangun1100" style="display: none; margin-top: 20px;">
    ...
    <div class="form-group" style="margin-top: 20px;">
        ...
        <select class="form-control" id="tahun_renovasi" name="tahun_renovasi"
            onchange="toggleCheckboxes1100(this, 'checkboxContainerRenovasi1100')">
            <script>
                const startYearRenovasi1100 = 1960;
                const endYearRenovasi1100 = currentYear1100 + 7;
                let optionsRenovasi1100 = '';

                for (let year = startYearRenovasi1100; year <= endYearRenovasi1100; year++) {
                    const selected = year === currentYear1100 ? 'selected' : '';
                    optionsRenovasi1100 += `<option value="${year}" ${selected}>${year}</option>`;
                }

                document.write(optionsRenovasi1100);
            </script>
        </select>
    </div>

    <div id="checkboxContainerRenovasi1100" style="display: none; margin-top: 20px;">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-8">
                <div class="canvas-container bg-white">
                    <canvas id="drawingCanvas_1100" width="800" height="600"></canvas>
                ...
                <div class="tools-container">
                    ...
                    <div class="nav-controls mb-3">
                        <div class="d-flex justify-content-center">
                            <div class="nav-button-group">
                                <button type="button" class="nav-btn" onclick="setDirection_1100('up')">
                                    <i class="fas fa-chevron-up"></i>
                                </button>
                                <div class="d-flex">
                                    <button type="button" class="nav-btn" onclick="setDirection_1100('left')">
                                        <i class="fas fa-chevron-left"></i>
                                    </button>
                                    <button type="button" class="nav-btn" onclick="setDirection_1100('down')">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                    <button type="button" class="nav-btn" onclick="setDirection_1100('right')">
                    ...
                    <div class="measurement-inputs">
                        <div class="input-group mb-3">
                            ...
                            <input type="number" id="distance_1100" class="form-control" placeholder="Jarak (m)">
                        </div>
                        <div class="input-group mb-4">
                            <span class="input-group-text">
                                <i class="fas fa-drafting-compass"></i>
                            </span>
                            <input type="number" id="angle_1100" class="form-control" placeholder="Sudut (°)">
                        </div>
                    </div>

                    <!-- Action Buttons -->
                    <div class="action-buttons mb-4">
                        <button type="button" class="btn btn-primary w-100 mb-2" onclick="drawLine_1100()">
                            <i class="fas fa-pen me-2"></i>Gambar Garis
                        </button>
                        <button type="button" class="btn btn-success w-100 mb-2" onclick="closePolygon_1100()">
                            <i class="fas fa-vector-square me-2"></i>Tutup Area
                        </button>
                        <button type="button" class="btn btn-outline-danger w-100" onclick="clearCanvas_1100()">
                    ...
                    <div class="form-fields">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_lantai_1100[]"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="btn-group w-100" role="group">
                                <input type="radio" class="btn-check" name="faktor_pengali_1100[]"
                                    id="pengali_1_1100" value="1" checked>
                                <label class="btn btn-outline-primary" for="pengali_1_1100">1.0</label>
                                <input type="radio" class="btn-check" name="faktor_pengali_1100[]"
                                    id="pengali_0.5_1100" value="0.5">
                                <label class="btn btn-outline-primary" for="pengali_0.5_1100">0.5</label>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="luas_bangunan_1100[]" placeholder="0"
                                step="0.01" readonly>
                        </div>
                    </div>
                </div>
    ...
    <div class="mt-3">
        <button type="button" class="btn btn-primary" id="add-lantai-btn_1100">
            <i class="fas fa-plus-circle me-2"></i>Tambah Lantai
        </button>
    </div>

    <div id="lantai-container-wrapper_1100">
...
<script>
    ...
    function toggleCheckboxes1100(selectElement, targetId) {
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const mainCanvas = document.getElementById('drawingCanvas_1100');
        if (mainCanvas) {
            // Set ukuran canvas sesuai dengan container
            resizeCanvas_1100(mainCanvas);

            // Inisialisasi canvas utama di sini
            setupCanvas_1100('drawingCanvas_1100');
            ...
            redrawCanvas_1100('drawingCanvas_1100');
        }

        // Fungsi untuk menambahkan lantai baru
        const addLantaiBtn = document.getElementById('add-lantai-btn_1100');
        if (addLantaiBtn) {
            addLantaiBtn.addEventListener('click', function() {
                        ...
                        <div class="col-md-4">
                            <div class="tools-container">
                                ...
                                <div class="nav-controls mb-3">
                                    <div class="d-flex justify-content-center">
                                        <div class="nav-button-group">
                                            <button type="button" class="nav-btn" onclick="setDirection_1100('up', '${uniqueId}')">
                                                <i class="fas fa-chevron-up"></i>
                                            </button>
                                            <div class="d-flex">
                                                <button type="button" class="nav-btn" onclick="setDirection_1100('left', '${uniqueId}')">
                                                    <i class="fas fa-chevron-left"></i>
                                                </button>
                                                <button type="button" class="nav-btn" onclick="setDirection_1100('down', '${uniqueId}')">
                                                    <i class="fas fa-chevron-down"></i>
                                                </button>
                                                <button type="button" class="nav-btn" onclick="setDirection_1100('right', '${uniqueId}')">
                                                    <i class="fas fa-chevron-right"></i>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <!-- Action Buttons -->
                                <div class="action-buttons mb-4">
                                    <button type="button" class="btn btn-primary w-100 mb-2" onclick="drawLine_1100('${uniqueId}')">
                                        <i class="fas fa-pen me-2"></i>Gambar Garis
                                    </button>
                                    <button type="button" class="btn btn-success w-100 mb-2" onclick="closePolygon_1100('${uniqueId}')">
                                        <i class="fas fa-vector-square me-2"></i>Tutup Area
                                    </button>
                                    <button type="button" class="btn btn-outline-danger w-100" onclick="clearCanvas_1100('${uniqueId}')">
                                        <i class="fas fa-undo me-2"></i>Hapus Garis Terakhir
                                    </button>
                                </div>
                                ...
                                <div class="form-fields">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="faktor_pengali_1100[]" value="1" class="pengali-value-${uniqueId}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="luas_bangunan_1100[]" id="luas_${uniqueId}" 
                ...
                const wrapper = document.getElementById('lantai-container-wrapper_1100');
                if (wrapper) {
                ...
                setTimeout(() => {
                    ...
                    if (newCanvas) {
                        ...
                        setupCanvas_1100(uniqueId);

                        // Gambar canvas awal
                        redrawCanvas_1100(uniqueId);
                    }
                }, 100);
    ...
    function resizeCanvas_1100(canvas) {
    ...
    function drawPoint_1100(x, y, ctx) {
        ctx.beginPath();
    ...
    function drawMeasurement_1100(startX, startY, endX, endY, distance, ctx, zoom = 1) {
    ...
    function calculateArea_1100(canvasId = 'drawingCanvas_1100') {
        let currentPoints;
        let currentScale;
        let currentZoom;

        if (canvasId === 'drawingCanvas_1100') {
    ...
    function setupCanvas_1100(canvasId) {
        ...
        window.addEventListener('resize', function() {
            resizeCanvas_1100(canvas);
            redrawCanvas_1100(canvasId);
        });
    }

    // Fungsi untuk menggambar ulang canvas dengan perbaikan
    function redrawCanvas_1100(canvasId = 'drawingCanvas_1100') {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return;
        ...
        drawGrid_1100(ctx, canvas.width, canvas.height, currentZoom, currentOffsetX, currentOffsetY, currentScale);
        ...
        for (let i = 0; i < currentPoints.length; i++) {
            ...
            if (i > 0) {
                ...
                drawMeasurement_1100(currentPoints[i - 1].x, currentPoints[i - 1].y,
        ...
        if (isAreaClosed) {
            const area = calculateArea_1100(canvasId);
            ...
            const luasInput = canvasId === 'drawingCanvas_1100' ?
                document.querySelector('input[name="luas_bangunan_1100[]"]') :
    ...
    function drawGrid_1100(ctx, width, height, zoom, offsetX, offsetY, gridSize) {
    ...
    function setDirection_1100(direction, canvasId = 'drawingCanvas_1100') {
        const distanceInput = document.getElementById(canvasId === 'drawingCanvas_1100' ? 'distance_1100' :
            `distance_${canvasId}`);
        const angleInput = document.getElementById(canvasId === 'drawingCanvas_1100' ? 'angle_1100' :
            `angle_${canvasId}`);
    ...
    function startPan_1100(e, canvasId = 'drawingCanvas_1100') {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return;
    ...
    function pan_1100(e, canvasId = 'drawingCanvas_1100') {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return;
    ...
    function endPan_1100(canvasId = 'drawingCanvas_1100') {
        const canvas = document.getElementById(canvasId);
        if (!canvas) return;
    ...
    function drawLine_1100(canvasId = 'drawingCanvas_1100') {
        const distanceInput = document.getElementById(canvasId === 'drawingCanvas_1100' ? 'distance_1100' :
            `distance_${canvasId}`);
        const angleInput = document.getElementById(canvasId === 'drawingCanvas_1100' ? 'angle_1100' :
            `angle_${canvasId}`);
    ...
    function closePolygon_1100(canvasId = 'drawingCanvas_1100') {
        // Dapatkan data untuk canvas yang sesuai
        let currentPoints;
    ...
    function clearCanvas_1100(canvasId = 'drawingCanvas_1100') {
        // Dapatkan data untuk canvas yang sesuai
        let currentPoints;
        ...
        if (formElements.length > 0) {
            formElements.forEach(form => {
                form.addEventListener('submit', function(e) {
                    ...
                    const canvasDataToSave = getCanvasData_1100();
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if (isset($bangunan->canvas_data) && $bangunan->tipe_spek === '200')
            ...
            if (savedData.main) {
                ...
                // Redraw canvas utama
                if (document.getElementById('drawingCanvas_1100')) {
                    redrawCanvas_1100('drawingCanvas_1100');
                    ...
                    if (points.length > 3 &&
                        points[0].x === points[points.length - 1].x &&
                        points[0].y === points[points.length - 1].y) {
                        const area = calculateArea_1100('drawingCanvas_1100');
                        const luasBangunanInput = document.querySelector('input[name="luas_bangunan_1100[]"]');
