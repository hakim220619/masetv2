...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const canvas = document.getElementById('drawingCanvas_1100');
        ...
        // Event listeners
        canvas.addEventListener('mousedown', startPan_1100);
        canvas.addEventListener('mousemove', pan_1100);
        canvas.addEventListener('mouseup', endPan_1100);
        canvas.addEventListener('mouseleave', endPan_1100);
        canvas.addEventListener('wheel', handleZoom_1100);

        // Fungsi untuk menginisialisasi canvas
        window.initCanvas_1100 = function() {
            ctx.strokeStyle = 'red';
            ctx.lineWidth = 2;
        ...
        function drawMeasurement_1100(startX, startY, endX, endY, distance) {
        ...
        window.drawLine_1100 = function() {
            let distance = parseFloat(document.getElementById('distance_1100').value);
            let angle = parseFloat(document.getElementById('angle_1100').value) || 0;
        ...
        function redrawCanvas_1100() {
            ...
            if (points.length > 0) {
                ...
                // Gambar titik-titik dan garis
                points.forEach((point, index) => {
                    drawPoint_1100(point.x, point.y);
        ...
        // Fungsi untuk menutup poligon
        window.closePolygon_1100 = function() {
            if (points.length < 3) {
            ...
            document.querySelector('input[name="luas_bangunan_1100[]"]').value = area.toFixed(2);
        ...
        window.clearCanvas_1100 = function() {
            if (points.length > 1) {
                points.pop();
                redrawCanvas_1100();
            }
        ...
        function endPan_1100() {
            isPanning = false;
        }

        // Fungsi untuk zoom
        function handleZoom_1100(e) {
            e.preventDefault();
...
<script>
    ...
    function getCanvasData() {
        return {
            ...
            tipe_spek: '1100' // tambahkan tipe_spek
        };
    }
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if (isset($bangunan->canvas_data) && $bangunan->tipe_spek === '1100')
