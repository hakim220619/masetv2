...
<script>
    $(document).ready(function() {
        $('.datatables-bangunan-view').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route("pembanding.tanahKosongLoadData") }}',
                type: 'GET',
                dataSrc: 'data'
            },
            columns: [
                ...
                { 
                    ...
                    render: function(data, type, row) {
                        return row.nip + ' - ' + row.nama_tanah_kosong + '-' + row.alamat;
                    }
                },
                {
                    data: null,
                    ...
                    searchable: false,
                    render: function(data, type, row) {
                        return '<a href="/pembanding/detail_pembanding_tanah_kosong/' + row.id + '" class="btn btn-sm btn-primary">Detail</a>';
                    }
                }
            ]
        });
